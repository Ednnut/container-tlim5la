...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tlim5la.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tlim5la.containers.anotherwebservice.com/
...
```
git clone git@github.com:Ednnut/container-tlim5la.git
cd container-tlim5la
```
...
```
docker attach container-tlim5la
```
